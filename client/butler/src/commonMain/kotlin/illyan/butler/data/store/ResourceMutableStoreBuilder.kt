...
fun provideResourceMutableStore(
    ...
    fetcher = Fetcher.ofFlow { key ->
        ...
        combine(
            flow { emit(listOf(resourceNetworkDataSource.fetch(key))) },
            flow { emit(emptyList<MessageDto>()); emitAll(resourceNetworkDataSource.fetchNewMessages()) }
        ) { message, newMessages ->
    ...
    sourceOfTruth = SourceOfTruth.of(
        ...
        delete = { key ->
            ...
            resourceNetworkDataSource.delete(key, chatId)
        },
        deleteAll = {
            databaseHelper.withDatabase {
