...
import illyan.butler.core.local.sql.model.RoomToken
...
class Converters {
    ...
    @TypeConverter
    fun toString(theming: Theming) = Json.encodeToString(theming)
    @TypeConverter
    fun toThemingMap(databaseValue: String) = Json.decodeFromString(Theming.serializer(), databaseValue)
}
