package illyan.butler.core.local.sql.dao
...
interface DataHistoryDao {
    @Insert
    suspend fun insertDataHistory(dataHistory: illyan.butler.core.local.sql.model.RoomDataHistory)

    @Delete
    suspend fun deleteDataHistory(dataHistory: illyan.butler.core.local.sql.model.RoomDataHistory)

    @Update
    suspend fun updateDataHistory(dataHistory: illyan.butler.core.local.sql.model.RoomDataHistory)
