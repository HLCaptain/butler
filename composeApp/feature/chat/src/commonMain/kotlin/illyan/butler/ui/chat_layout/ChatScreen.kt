...
fun ChatScreen(
    ...
    var chatId by rememberSaveable(currentChat) { mutableStateOf(currentChat) }
    ...
    ListDetailPaneScaffold(
        ...
        detailPane = {
            AnimatedPane {
                ...
                ChatDetailScreen(state, viewModel, navigator.currentDestination?.content, navigator.canNavigateBack(), navBarWindowInsets) {
                    navigator.navigateBack()
                }
            }
        }
